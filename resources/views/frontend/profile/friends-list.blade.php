    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        @foreach ($friendList as $friend)
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                <img src="@if(isset($friend->currentProfileImage)) {{ Storage::url($friend->currentProfileImage->path) }} @else {{ secure_asset('assets/img/dummy-user.jpg') }} @endif" alt="Friend" class="w-full h-50 object-cover">
                <div class="p-3">
