...
class AuthController extends Controller
{
    ...
    public function signUpUser(Request $request)
    {
        $validated = $request->validate([
            ...
            'counsellor_name.required' => 'Please enter your counsellor name',
            'university_name.required' => 'Please enter your university name',
            'year_of_admission.required' => 'Please enter your year of admission',
        ...
        try {
            $user = User::create([
                ...
                'year_of_admission' => $validated['year_of_admission'],
                // 'is_approve' => true,
